...
# takes a bit longer than plain SMOTE because of the cleaning step
print("applying SMOTETomek (takes a few minutes)...")
...
# notice the counts are slightly below 67343 unlike plain SMOTE
# thats because Tomek also removed some ambiguous examples
...
print(f"experiment 3 (smotetomek):        {score:.4f}")
...
plt.ylabel("Actual")
plt.title(f"Experiment 3 - XGBoost + SMOTETomek\nMacro F1: {score:.4f}")
plt.tight_layout()
plt.savefig("exp3_confusion_matrix.png", dpi=150)
plt.show()

print("\ndone - saved as exp3_confusion_matrix.png")
